...
const I18N = {
  "en": {
    ...
    "sec.sensors.p": "Five sensor protocol layers are tested offline — four against vendor manual example frames, plus the Meta DIGIT vision-tactile identity and semantics layer. Live acquisition and real-world stability will be verified when the sensors arrive.",
    "sn.th1": "Sensor",
    "sn.th2": "Output",
    "sn.th3": "Link",
    "sn.th4": "Status",
  ...
  "zh": {
    ...
    "sec.sensors.p": "五款传感器协议层均已离线验证——四款按厂商手册示例帧逐字节测试，另有 Meta DIGIT 视觉触觉身份识别与语义层。传感器到位后，将验证实时采集与真实环境下的运行稳定性。",
    "sn.th1": "传感器",
    "sn.th2": "输出",
    "sn.th3": "链路",
    "sn.th4": "状态",
